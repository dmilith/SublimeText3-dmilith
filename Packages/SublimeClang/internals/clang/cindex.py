...
def _encode(arg):
    if isinstance(arg, str):
        return arg.encode(_encoding_type, 'ignore')
    return arg

def _decode(arg):
    if not isinstance(arg, str):
        return arg.decode(_encoding_type, 'ignore')
    return arg
...
class SourceLocation(Structure):
    ...
    def from_position(tu, file, line, column):
        ...
        """
        return conf.lib.clang_getLocation(tu, _encode(file), line, column)
    ...
    def from_offset(tu, file, offset):
        ...
        """
        return conf.lib.clang_getLocationForOffset(tu, _encode(file), offset)
...
class Diagnostic(object):
    ...
    @property
    def spelling(self):
        return _decode(conf.lib.clang_getDiagnosticSpelling(self))
...
class Cursor(Structure):
    ...
    def displayname(self):
        ...
        return _decode(self._displayname)
    ...
    def get_included_file(self):
        res = conf.lib.clang_getIncludedFile(self)
        if not res:
            return None
        return File(res)
    ...
    def get_returned_pointer_level(self, curr=0):
        ...
        while type :
            if type.kind == TypeKind.POINTER:
                ...
                if len(children) >0 and children[0].kind == CursorKind.TYPE_REF:
    ...
    def get_resolved_cursor(self, parent=None):
        ...
        if self.kind == CursorKind.TYPEDEF_DECL:
            ...
            val = self.get_children().next()
            return var.get_resolved_cursor() if var else None
...
class TypeKind(object):
    ...
    def spelling(self):
        ...
        return _decode(conf.lib.clang_getTypeKindSpelling(self.value))
...
class Type(Structure):
    ...
    def spelling(self):
        ...
        return _decode(conf.lib.clang_getTypeSpelling(self))
...
class CompletionChunk:
    ...
    def __repr__(self):
        return "{'" +  _decode(self.spelling) + "', " + str(self.kind) + "}"
...
class TranslationUnit(ClangObject):
    ...
    def from_source(cls, filename, args=None, unsaved_files=None, options=0,
        ...
        if isinstance(filename, str):
            filename = filename.encode(_encoding_type)
    ...
    def spelling(self):
        ...
        return _decode(conf.lib.clang_getTranslationUnitSpelling(self))
    ...
    def save(self, filename):
        ...
        result = int(conf.lib.clang_saveTranslationUnit(self, _encode(filename),
                                                        options))
        if result != 0:
    ...
    def codeComplete(self, path, line, column, unsaved_files=None,
        ...
        if len(unsaved_files):
            ...
            for i, (name, contents) in enumerate(unsaved_files):
                ...
                unsaved_files_array[i].contents = contents
                unsaved_files_array[i].length = len(contents)
        ptr = conf.lib.clang_codeCompleteAt(self, _encode(path), line, column,
...
class File(ClangObject):
    ...
    def from_name(translation_unit, file_name):
        ...
        return File(conf.lib.clang_getFile(translation_unit, _encode(file_name)))

    @property
    def name(self):
        """Return the complete file and path name of the file."""
        return _decode(conf.lib.clang_getCString(conf.lib.clang_getFileName(self)))
...
class CompilationDatabase(ClangObject):
    ...
    def fromDirectory(buildDir):
        ...
        errorCode = c_uint()
        try:
            cdb = conf.lib.clang_CompilationDatabase_fromDirectory(_encode(buildDir),
                byref(errorCode))
...
class Token(Structure):
    ...
    def spelling(self):
        ...
        """
        return _decode(conf.lib.clang_getTokenSpelling(self._tu, self))
